...
class Request:
  ...
  def writeTextInImage(self, image, title):
    ...
    w, h = img.size
    editableImage.text(((w - text_w) // 2, (h - text_h) - 50), title, (255,255,255), font=titleFont, stroke_width=2, stroke_fill='black')
    # editableImage.text((15, 15), title, (237, 230, 211), font=titleFont)
  ...
  def getdata(self):
    ...
    for_cookies = my_session.get(self.pages)
    cookies = for_cookies.cookies
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:57.0) Gecko/20100101 Firefox/57.0'}

    response = my_session.get(self.pages, headers=headers, cookies=cookies)
